...
def main() -> bool:
    '''
        Bootstraps and runs the gen_message_queue with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_message_queue: GenMessageQueue = GenMessageQueue(GenMessageQueueBundleFactory.create_bundle())

    return gen_message_queue.process()


if __name__ == '__main__':
    '''
        Entry point for gen_message_queue execution.
