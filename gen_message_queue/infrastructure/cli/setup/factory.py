...
from gen_message_queue.infrastructure.cli.setup.options import CLIBundleOptions
from gen_message_queue.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_message_queue.infrastructure.cli.setup.bundle import CLIBundle
from gen_message_queue.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_message_queue.infrastructure.command.icommand_definition import ICommandDefinition
from gen_message_queue.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenMessageQueueCommandDefinition()
        service_executor: ICommandExecutor = GenMessageQueueCommandExecutor(definition=service_definition)
