...
Info
    Defines GenMessageQueueCommandDefinition class.
'''
...
class GenMessageQueueCommandDefinition:
    '''
        CLI subcommand metadata definition for message_queue project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate MessageQueue project skeleton'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            OptionData(
                name="--name",
                help_text="message_queue project name",
                action=None,
                default="myapp",
                required=True,
                choices=None,
            ...
            OptionData(
                name="--type",
                help_text="project type (posix or sysv)",
                action=None,
                default="posix",
                required=True,
                choices=["posix", "sysv"],
