...
Info
    Defines GenMessageQueueCommandExecutor class.
'''
...
class GenMessageQueueCommandExecutor:
    '''
        Command executor strategy for generating message_queue project files.
    ...
    def __str__(self) -> str:
        '''
            Returns the GenMessageQueueCommandExecutor as string representation.

            :return: The GenMessageQueueCommandExecutor as string representation.
        '''
        return to_str(self)
