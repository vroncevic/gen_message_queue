...
Info
    A validator for the gen_message_queue bundle.
'''
...
class GenMessageQueueBundleValidator:
    '''
        A validator for the gen_message_queue bundle.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_message_queue bundle.
                | is_valid - Checks if the gen_message_queue bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenMessageQueueBundle) -> None:
        '''
            Validates the gen_message_queue bundle.

            :param bundle: The gen_message_queue bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_message_queue_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_message_queue bundle must be provided'
        msg_bundle_istype: str = 'the gen_message_queue bundle must be an instance of GenMessageQueueBundle'
        ...
        istype(bundle, GenMessageQueueBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, genmessagequeuebundle: GenMessageQueueBundle) -> bool:
        '''
            Checks if the genmessagequeuebundle is valid.

            :param genmessagequeuebundle: The genmessagequeuebundle to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(genmessagequeuebundle)
            return True
