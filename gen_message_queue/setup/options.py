...
Info
    GenMessageQueue bundle options for the gen_message_queue bundle.
'''
...
class GenMessageQueueBundleOptions(TypedDict):
    '''
        GenMessageQueue bundle options for the gen_message_queue bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_message_queue bundle.
    '''
