...
Info
    GenMessageQueue bundle dependencies for the gen_message_queue bundle.
'''
...
class GenMessageQueueBundleDependencies(TypedDict):
    '''
        GenMessageQueue bundle dependencies for the gen_message_queue bundle.
        ...
        It defines:
            ...
            :attributes:
                | base - The base bundle with the base components for the gen_message_queue bundle.
                | service - The service orchestrating the gen_message_queue's execution for the gen_message_queue bundle.
                | subprocessor - The adapter executing the gen_message_queue's sub-processes for the gen_message_queue bundle.
                | cli - The command-line interface adapter for the gen_message_queue bundle.
    '''
