...
Info
    Defines the gen_message_queue bundle.
'''
...
class GenMessageQueueBundle:
    '''
        GenMessageQueue bundle holding the components of the gen_message_queue.

        It defines:

            :attributes:
                | base - The base bundle with the base components.
                | service - The service orchestrating the gen_message_queue's execution.
                | subprocessor - The adapter executing the gen_message_queue's sub-processes.
                | cli - The command-line interface adapter.
            :methods:
                | to_dict - Converts the gen_message_queue bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the gen_message_queue bundle to a dictionary.

            :return: Dictionary representation of the gen_message_queue bundle.
            :exceptions: None.
        '''
