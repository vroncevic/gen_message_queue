...
Module
    registry_test.py
Info
    Unit tests for GenMessageQueueBundleRegistry class.
'''
...
class TestGenMessageQueueBundleRegistry(unittest.TestCase):
    ...
    def test_create_bundle_success(self) -> None:
        ...
        bundle = GenMessageQueueBundleRegistry.create_bundle(dependencies)
