...
Module
    test_engine.py
Info
    Unit tests for GenMessageQueue engine.
'''
...
class TestGenMessageQueue(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_message_queue/infrastructure/config/gen_message_queue.cfg',
                use_generator=True,
    ...
    @patch('gen_message_queue.setup.validator.GenMessageQueueBundleValidator.validate')
    ...
    def test_cli_bundle_factory(self) -> None:
        from gen_message_queue.infrastructure.cli.setup.factory import CLIBundleFactory
