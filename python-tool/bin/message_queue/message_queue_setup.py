...
class MQESetup(object):
    """
        Define class MQESetup with attribute(s) and method(s).
        ...
        It defines:
            ...
            method:
                ...
                gen_mqe_setup - Generate project skeleton
    """

    __slots__ = ('VERBOSE')
    VERBOSE = 'GEN_MESSAGE_QUEUE::GEN_MESSAGE_QUEUE_SETUP::MQESETUP'
    ...
    def __init__(self, verbose=False):
        """
            ...
            :exceptions: None
        """
        verbose_message(MQESetup.VERBOSE, verbose, 'Initial setup')
        pass

    def gen_mqe_setup(self, project_name, verbose=False):
        """
