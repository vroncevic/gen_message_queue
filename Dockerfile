...
RUN mkdir /gen_message_queue/
COPY gen_message_queue /gen_message_queue/
COPY setup.py /
COPY README.md /
RUN find /gen_message_queue/ -name "*.editorconfig" -type f -exec rm -Rf {} \;
