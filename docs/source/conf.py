...
htmlhelp_basename: str = 'gen_message_queuedoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_message_queue.tex', 'gen_message_queue Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_message_queue', 'gen_message_queue Documentation',
    [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_message_queue', 'gen_message_queue Documentation', author,
    'gen_message_queue', 'One line description of project.', 'Miscellaneous'
)]
